    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactPerson", x => new { x.ContactsId, x.PersonsId });
                    table.ForeignKey(
                        name: "FK_ContactPerson_Contacts_ContactsId",
                        column: x => x.ContactsId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactPerson_Persons_PersonsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactPerson_PersonsId",
                table: "ContactPerson",
                column: "PersonsId");
        }
